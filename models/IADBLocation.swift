...
class IADBLocation: IADBModel {
    ...
    class func findNear(location: CLLocation, withinNM distance: CLLocationDistance) -> IADBCenteredArray {
    ...
    class func findNear(location: CLLocation, withinNM distance: CLLocationDistance, withTypes types: [String]?) -> IADBCenteredArray {
    ...
    class func findByIdentifier(identifier: String) -> IADBLocation? {
    ...
    class func findAllByIdentifier(identifier: String) -> IADBCenteredArray {
        if self.isLocationSuperclass() {
            return self.eachSubclass({(klass: IADBLocation.Type) -> IADBCenteredArray in
    ...
    class func findAllByIdentifier(identifier: String, withTypes types: [String]?) -> IADBCenteredArray {
    ...
    class func findAllByIdentifiers(identifiers: [String], withTypes types: [String]?) -> IADBCenteredArray {
    ...
    class func findAllByPredicate(predicate: NSPredicate) -> IADBCenteredArray {
